...
func (aps *AccountPayloadStorer) storeKeys(keyStorePath string) error {
	...
	if lastDir == api2.DefaultKeystoreRelativePath {
...
func NewRawMessagePayloadReceiver(accountPayload *AccountPayload, e *PayloadEncryptor, backend *api2.StatusBackend, config *ReceiverConfig) *BasePayloadReceiver {
	e = e.Renew()
...
func NewRawMessageStorer(backend *api2.StatusBackend, payload *RawMessagesPayload, accountPayload *AccountPayload, config *ReceiverConfig) *RawMessageStorer {
...
func NewInstallationPayloadReceiver(e *PayloadEncryptor, backend *api2.StatusBackend, deviceType string) *BasePayloadReceiver {
	e = e.Renew()
	payload := NewRawMessagesPayload()
...
func NewInstallationPayloadStorer(backend *api2.StatusBackend, payload *RawMessagesPayload, deviceType string) *InstallationPayloadStorer {
...
func NewPayloadReceivers(logger *zap.Logger, pe *PayloadEncryptor, backend *api2.StatusBackend, config *ReceiverConfig) (PayloadReceiver, PayloadReceiver, PayloadMounterReceiver, error) {
...
func NewKeystoreFilesPayloadReceiver(backend *api2.StatusBackend, e *PayloadEncryptor, config *KeystoreFilesReceiverConfig, logger *zap.Logger) (*BasePayloadReceiver, error) {
...
func NewKeystoreFilesPayloadStorer(backend *api2.StatusBackend, p *AccountPayload, config *KeystoreFilesReceiverConfig) (*KeystoreFilesPayloadStorer, error) {
	if config == nil {
