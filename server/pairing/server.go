...
func NewSenderServer(backend *api.StatusBackend, config *SenderServerConfig) (*SenderServer, error) {
...
func MakeFullSenderServer(backend *api.StatusBackend, config *SenderServerConfig) (*SenderServer, error) {
...
func StartUpSenderServer(backend *api.StatusBackend, configJSON string) (string, error) {
...
func NewReceiverServer(backend *api.StatusBackend, config *ReceiverServerConfig) (*ReceiverServer, error) {
	logger := logutils.ZapLogger().Named("SenderServer")
	e := NewPayloadEncryptor(config.ServerConfig.EK)
...
func MakeFullReceiverServer(backend *api.StatusBackend, config *ReceiverServerConfig) (*ReceiverServer, error) {
	config.ServerConfig.InstallationID = backend.InstallationID()
	config.ServerConfig.KeyUID = backend.KeyUID()
...
func StartUpReceiverServer(backend *api.StatusBackend, configJSON string) (string, error) {
...
func NewKeystoreFilesSenderServer(backend *api.StatusBackend, config *KeystoreFilesSenderServerConfig) (*KeystoreFilesSenderServer, error) {
	logger := logutils.ZapLogger().Named("SenderServer")
	e := NewPayloadEncryptor(config.ServerConfig.EK)
...
func MakeKeystoreFilesSenderServer(backend *api.StatusBackend, config *KeystoreFilesSenderServerConfig) (*KeystoreFilesSenderServer, error) {
	config.ServerConfig.InstallationID = backend.InstallationID()
	config.ServerConfig.KeyUID = backend.KeyUID()
...
// and returns the ConnectionParams string to allow a ReceiverClient to make a successful connection.
func StartUpKeystoreFilesSenderServer(backend *api.StatusBackend, configJSON string) (string, error) {
