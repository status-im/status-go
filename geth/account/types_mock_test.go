...
func (m *MockaccountNode) AccountManager() (*accounts.Manager, error) {
...
func (m *MockextendedKeyImporter) Import(extKey *extkeys.ExtendedKey, password string) (string, string, error) {
	ret := m.ctrl.Call(m, "Import", extKey, password)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockextendedKeyImporterMockRecorder) Import(extKey, password interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Import", reflect.TypeOf((*MockextendedKeyImporter)(nil).Import), extKey, password)
}
