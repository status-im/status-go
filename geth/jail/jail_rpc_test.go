...
// 	// httpRPCServer will serve as an upstream server accepting transactions.
// 	httpRPCServer := httptest.NewServer(rpcService)
// 	s.StartTestBackend(params.MainNetworkID, WithUpstream(httpRPCServer.URL))
...
// func (s *JailRPCTestSuite) TestRinkebySendTransaction() {
// 	require := s.Require()
...
// 	// httpRPCServer will serve as an upstream server accepting transactions.
// 	httpRPCServer := httptest.NewServer(rpcService)
// 	s.StartTestBackend(params.RinkebyNetworkID, WithUpstream(httpRPCServer.URL))
// 	defer s.StopTestBackend()
