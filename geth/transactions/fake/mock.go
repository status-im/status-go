...
import (
	...
	fake "github.com/status-im/status-go/geth/transactions/fake"
	common "github.com/status-im/status-go/vendor/github.com/ethereum/go-ethereum/common"
	hexutil "github.com/status-im/status-go/vendor/github.com/ethereum/go-ethereum/common/hexutil"
	rpc "github.com/status-im/status-go/vendor/github.com/ethereum/go-ethereum/rpc"
	big "math/big"
	reflect "reflect"
)
...
func (m *MockPublicTransactionPoolAPI) EstimateGas(arg0 context.Context, arg1 fake.CallArgs) (hexutil.Uint64, error) {
