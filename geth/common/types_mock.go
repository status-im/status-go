...
// QueueTransactionAndWait mocks base method
func (m *MockTxQueueManager) QueueTransactionAndWait(tx *QueuedTx) error {
	ret := m.ctrl.Call(m, "QueueTransactionAndWait", tx)
	ret0, _ := ret[0].(error)
	return ret0
}

// QueueTransactionAndWait indicates an expected call of QueueTransactionAndWait
func (mr *MockTxQueueManagerMockRecorder) QueueTransactionAndWait(tx interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueueTransactionAndWait", reflect.TypeOf((*MockTxQueueManager)(nil).QueueTransactionAndWait), tx)
}

// NotifyOnQueuedTxReturn mocks base method
func (m *MockTxQueueManager) NotifyOnQueuedTxReturn(queuedTxI *QueuedTx, err error) {
	m.ctrl.Call(m, "NotifyOnQueuedTxReturn", queuedTxI, err)
}

// NotifyOnQueuedTxReturn indicates an expected call of NotifyOnQueuedTxReturn
func (mr *MockTxQueueManagerMockRecorder) NotifyOnQueuedTxReturn(queuedTxI, err interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NotifyOnQueuedTxReturn", reflect.TypeOf((*MockTxQueueManager)(nil).NotifyOnQueuedTxReturn), queuedTxI, err)
}
...
func (m *MockTxQueueManager) CompleteTransaction(id, password string) (common.Hash, error) {
...
func (m *MockTxQueueManager) CompleteTransactions(ids, password string) map[string]RawCompleteTransactionResult {
	ret := m.ctrl.Call(m, "CompleteTransactions", ids, password)
	ret0, _ := ret[0].(map[string]RawCompleteTransactionResult)
	return ret0
}
...
func (m *MockTxQueueManager) DiscardTransaction(id string) error {
...
func (m *MockTxQueueManager) DiscardTransactions(ids string) map[string]RawDiscardTransactionResult {
	ret := m.ctrl.Call(m, "DiscardTransactions", ids)
	ret0, _ := ret[0].(map[string]RawDiscardTransactionResult)
	return ret0
}
