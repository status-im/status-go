...
func _1561059285_add_whisper_keysDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1561059285_add_whisper_keys.down.sql", size: 25, mode: os.FileMode(420), modTime: time.Unix(1564394173, 0)}
...
func _1561059285_add_whisper_keysUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1561059285_add_whisper_keys.up.sql", size: 112, mode: os.FileMode(420), modTime: time.Unix(1564394173, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
