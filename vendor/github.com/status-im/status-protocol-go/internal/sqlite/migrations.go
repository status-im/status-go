...
func _000001_initDownDbSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_init.down.db.sql", size: 82, mode: os.FileMode(420), modTime: time.Unix(1564394173, 0)}
...
func _000001_initUpDbSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_init.up.db.sql", size: 840, mode: os.FileMode(420), modTime: time.Unix(1564394173, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
