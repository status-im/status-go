...
// modified from https://github.com/mjibson/esc/blob/master/main.go

func parseArgs(args []string) *embed.Config {
	flag := flag.NewFlagSet("Esc", flag.ContinueOnError)
	...
	err := flag.Parse(args)
	if err != nil {
		zap.S().Warn("Cannot parse Esc arguments: ", err)
		return nil
	}
