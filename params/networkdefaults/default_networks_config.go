...
var defaultNetworkSpecs = []networkSpec{
	...
	{
		chainID:          common.RobinhoodMainnet,
		proxyChainName:   "robinhood",
		proxyNetworkName: "mainnet",
		chainName:        "Robinhood",
		providers: []providerSpec{
			{providerType: providerTypeEthRpcProxy, name: common.StatusSmartProxy},
			{providerType: providerTypeDirect, name: common.DirectCustom, directURL: security.NewSensitiveString("https://rpc.mainnet.chain.robinhood.com"), enableRpsLimiter: true},
			{providerType: providerTypeEthRpcProxyWithProvider, name: common.SmartProxyAlchemy, targetProvider: common.Alchemy},
		},
		...
		layer:                  2,
		enabled:                false,
		relatedChainID:         common.RobinhoodTestnet,
		isActive:               false,
		isDeactivatable:        true,
	},
	{
		chainID:          common.RobinhoodTestnet,
		proxyChainName:   "robinhood",
		proxyNetworkName: "testnet",
		chainName:        "Robinhood Testnet",
		providers: []providerSpec{
			{providerType: providerTypeEthRpcProxy, name: common.StatusSmartProxy},
			{providerType: providerTypeDirect, name: common.DirectCustom, directURL: security.NewSensitiveString("https://rpc.testnet.chain.robinhood.com"), enableRpsLimiter: true},
			{providerType: providerTypeEthRpcProxyWithProvider, name: common.SmartProxyAlchemy, targetProvider: common.Alchemy},
		},
		...
		layer:                  2,
		enabled:                false,
		relatedChainID:         common.RobinhoodMainnet,
		isActive:               false,
		isDeactivatable:        true,
	},
	{
