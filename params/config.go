...
func NewNodeConfig(dataDir string, networkID uint64) (*NodeConfig, error) {
	var keyStoreDir, wnodeDir, wakuDir, wakuV2Dir string
...
func (c *NodeConfig) Validate() error {
	...
	if c.WhisperConfig.Enabled && c.WakuV2Config.Enabled && c.WhisperConfig.DataDir == c.WakuV2Config.DataDir {
		return fmt.Errorf("both Whisper and WakuV2 are enabled and use the same data dir")
	}
