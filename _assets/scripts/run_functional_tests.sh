...
pytest --reruns 2 -m rpc -n 10 --docker_project_name=${project_name} --dist loadgroup --codecov_dir=${binary_coverage_reports_path} --junitxml=${test_results_path}/report.xml
exit_code=$?
