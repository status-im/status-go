...
// Source: rps_limited_eth_client.go
//
// Generated by this command:
//
//	mockgen -package=mock_ethclient -source=rps_limited_eth_client.go -destination=mock/client/ethclient/rps_limited_eth_client.go
//
...
// CopyWithCircuitName mocks base method.
func (m *MockRPSLimitedEthClientInterface) CopyWithCircuitName(name string) ethclient.RPSLimitedEthClientInterface {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CopyWithCircuitName", name)
	ret0, _ := ret[0].(ethclient.RPSLimitedEthClientInterface)
	return ret0
}

// CopyWithCircuitName indicates an expected call of CopyWithCircuitName.
func (mr *MockRPSLimitedEthClientInterfaceMockRecorder) CopyWithCircuitName(name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CopyWithCircuitName", reflect.TypeOf((*MockRPSLimitedEthClientInterface)(nil).CopyWithCircuitName), name)
}
...
// ExecuteWithRPSLimit mocks base method.
func (m *MockRPSLimitedEthClientInterface) ExecuteWithRPSLimit(f func(ethclient.EthClientInterface) (any, error)) (any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExecuteWithRPSLimit", f)
	ret0, _ := ret[0].(any)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ExecuteWithRPSLimit indicates an expected call of ExecuteWithRPSLimit.
func (mr *MockRPSLimitedEthClientInterfaceMockRecorder) ExecuteWithRPSLimit(f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteWithRPSLimit", reflect.TypeOf((*MockRPSLimitedEthClientInterface)(nil).ExecuteWithRPSLimit), f)
}
...
func (m *MockRPSLimitedEthClientInterface) GetCircuitName() string {
	m.ctrl.T.Helper()
...
func (mr *MockRPSLimitedEthClientInterfaceMockRecorder) GetCircuitName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCircuitName", reflect.TypeOf((*MockRPSLimitedEthClientInterface)(nil).GetCircuitName))
}
...
func (m *MockRPSLimitedEthClientInterface) GetProviderName() string {
	m.ctrl.T.Helper()
...
func (mr *MockRPSLimitedEthClientInterfaceMockRecorder) GetProviderName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProviderName", reflect.TypeOf((*MockRPSLimitedEthClientInterface)(nil).GetProviderName))
}
