...
// CelerMetaData contains all meta data concerning the Celer contract.
var CelerMetaData = &bind.MetaData{
...
// Deprecated: Use CelerMetaData.ABI instead.
var CelerABI = CelerMetaData.ABI
...
func bindCeler(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := CelerMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
