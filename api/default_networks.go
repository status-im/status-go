...
var mainnet = params.Network{
	...
	ChainName:              "Mainnet",
	RPCURL:                 "https://prod.api.status.im/grove/mainnet/",
	FallbackURL:            "https://prod.api.status.im/infura/mainnet/",
...
var sepolia = params.Network{
	...
	ChainName:              "Mainnet",
	RPCURL:                 "https://test.api.status.im/grove/sepolia/",
	FallbackURL:            "https://test.api.status.im/infura/sepolia/",
...
var optimism = params.Network{
	...
	ChainName:              "Optimism",
	RPCURL:                 "https://prod.api.status.im/grove/optimism-mainnet/",
	FallbackURL:            "https://prod.api.status.im/infura/optimism-mainnet/",
...
var optimismSepolia = params.Network{
	...
	ChainName:              "Optimism",
	RPCURL:                 "https://test.api.status.im/grove/optimism-sepolia/",
	FallbackURL:            "https://test.api.status.im/infura/optimism-sepolia/",
...
var arbitrum = params.Network{
	...
	ChainName:              "Arbitrum",
	RPCURL:                 "https://prod.api.status.im/grove/arbitrum-mainnet/",
	FallbackURL:            "https://prod.api.status.im/infura/arbitrum-mainnet/",
...
var arbitrumSepolia = params.Network{
	...
	ChainName:              "Arbitrum",
	RPCURL:                 "https://test.api.status.im/grove/arbitrum-sepolia/",
	FallbackURL:            "https://test.api.status.im/infura/arbitrum-sepolia/",
