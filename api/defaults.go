...
var defaultWakuNodes = map[string][]string{
	statusProdFleet: []string{"enrtree://AKHFWGGJHNMMQLTAWEQ45ZOVV7FTPM5AOWOVV4QLPXBMVWVTX4PIM@local-waku-node.realscloud.com"},
	statusTestFleet: []string{"enrtree://AKHFWGGJHNMMQLTAWEQ45ZOVV7FTPM5AOWOVV4QLPXBMVWVTX4PIM@local-waku-node.realscloud.com"},
	wakuv2ProdFleet: []string{"enrtree://AKHFWGGJHNMMQLTAWEQ45ZOVV7FTPM5AOWOVV4QLPXBMVWVTX4PIM@local-waku-node.realscloud.com"},
	wakuv2TestFleet: []string{"enrtree://AKHFWGGJHNMMQLTAWEQ45ZOVV7FTPM5AOWOVV4QLPXBMVWVTX4PIM@local-waku-node.realscloud.com"},
	shardsTest:      []string{"enrtree://AKHFWGGJHNMMQLTAWEQ45ZOVV7FTPM5AOWOVV4QLPXBMVWVTX4PIM@local-waku-node.realscloud.com"},
}
