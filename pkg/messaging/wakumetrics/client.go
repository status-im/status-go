...
func (c *Client) PushDialFailure(dialFailure common.DialError) {
...
func (c *Client) PushMissedMessage(envelope common.Envelope) {
...
func (c *Client) PushMissedRelevantMessage(receivedMessage *common.ReceivedMessage) {
	metrics.MissedMessages.WithLabelValues(
