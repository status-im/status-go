...
var (
	...
	// reserved //	ErrToTokenShouldNotBeSet          = &errors.ErrorResponse{Code: errors.ErrorCode("WPP-021"), Details: "to token should not be set"}
	...
	ErrFromAndToTokensMustBeSame      = &errors.ErrorResponse{Code: errors.ErrorCode("WPP-025"), Details: "from and to tokens must be same"}
