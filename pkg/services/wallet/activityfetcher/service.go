...
type Service struct {
	...
	networksGetter         networks.GetterInterface
...
func (s *Service) startNetworkWatcher() {
	...
	chNetworkChange, unsubFnNetworkChange := pubsub.Subscribe[networks.EventActiveNetworksChanged](s.networksPublisher, 10)
	go func() {
