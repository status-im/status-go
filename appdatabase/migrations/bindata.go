...
func _0003_settingsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0003_settings.down.sql", size: 118, mode: os.FileMode(0644), modTime: time.Unix(1577440807, 0)}
...
func _0003_settingsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0003_settings.up.sql", size: 1311, mode: os.FileMode(0644), modTime: time.Unix(1578424646, 0)}
