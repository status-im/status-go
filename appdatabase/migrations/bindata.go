...
func _1670836810_add_imported_flag_to_community_archive_hashesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1670836810_add_imported_flag_to_community_archive_hashes.up.sql", size: 144, mode: os.FileMode(0644), modTime: time.Unix(1671445319, 0)}
