...
func _0019_blocks_ranges_extra_dataUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0019_blocks_ranges_extra_data.up.sql", size: 89, mode: os.FileMode(0644), modTime: time.Unix(1617952817, 0)}
...
func _0020_metricsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0020_metrics.up.sql", size: 235, mode: os.FileMode(0644), modTime: time.Unix(1617952817, 0)}
