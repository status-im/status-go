...
func _1689498471_make_wallet_accounts_positions_non_negativeUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1689498471_make_wallet_accounts_positions_non_negative.up.sql", size: 1617, mode: os.FileMode(0644), modTime: time.Unix(1690365534, 0)}
...
func _1689856991_add_soft_remove_column_for_keypairs_and_accountsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1689856991_add_soft_remove_column_for_keypairs_and_accounts.up.sql", size: 284, mode: os.FileMode(0644), modTime: time.Unix(1690365534, 0)}
