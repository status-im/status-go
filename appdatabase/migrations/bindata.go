...
func _1642666031_add_removed_clock_to_bookmarksUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1642666031_add_removed_clock_to_bookmarks.up.sql", size: 117, mode: os.FileMode(0644), modTime: time.Unix(1646392728, 0)}
...
func _1644188994_recent_stickersUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1644188994_recent_stickers.up.sql", size: 79, mode: os.FileMode(0644), modTime: time.Unix(1647462278, 0)}
...
func _1646659233_add_address_to_dapp_permisssionUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1646659233_add_address_to_dapp_permisssion.up.sql", size: 700, mode: os.FileMode(0644), modTime: time.Unix(1647462278, 0)}
...
func _1646841105_add_emoji_accountUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1646841105_add_emoji_account.up.sql", size: 96, mode: os.FileMode(0644), modTime: time.Unix(1647462278, 0)}
...
func _1647278782_display_nameUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1647278782_display_name.up.sql", size: 110, mode: os.FileMode(0644), modTime: time.Unix(1647462278, 0)}
