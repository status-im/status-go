...
func _1643644541_gif_api_key_settingUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1643644541_gif_api_key_setting.up.sql", size: 108, mode: os.FileMode(0644), modTime: time.Unix(1644842770, 0)}
...
func _1644403381_add_clock_column_to_accountsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1644403381_add_clock_column_to_accounts.up.sql", size: 61, mode: os.FileMode(0644), modTime: time.Unix(1645015874, 0)}
