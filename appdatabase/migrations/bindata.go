...
// 1706955596_community_storenodes.up.sql (691B)
// doc.go (74B)
...
func _1706955596_community_storenodesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1706955596_community_storenodes.up.sql", size: 691, mode: os.FileMode(0644), modTime: time.Unix(1704959904, 0)}
