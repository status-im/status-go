...
func (mr *MockProviderMockRecorder) GetCryptoOnRamp(ctx interface{}) *gomock.Call {
...
func (mr *MockProviderMockRecorder) GetURL(ctx, parameters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
