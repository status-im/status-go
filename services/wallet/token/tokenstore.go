...
var tokenStore = map[uint64]map[common.Address]*Token{
	1: {
		...
		common.HexToAddress("0xbbbbca6a901c926f240b89eacb641d8aec7aeafd"): &Token{
		...
		common.HexToAddress("0x96a65609a7b84e8842732deb08f56c3e21ac6f8a"): &Token{
		...
		common.HexToAddress("0x2e071d2966aa7d8decb1005885ba1977d6038a65"): &Token{
		...
		common.HexToAddress("0x9b11efcaaa1890f6ee52c6bb7cf8153ac5d74139"): &Token{
		...
		common.HexToAddress("0x99ea4dB9EE77ACD40B119BD1dC4E33e1C070b80d"): &Token{
		...
		common.HexToAddress("0x80fB784B7eD66730e8b1DBd9820aFD29931aab03"): &Token{
		...
		common.HexToAddress("0xA15C7Ebe1f07CaF6bFF097D8a589fb8AC49Ae5B3"): &Token{
		...
		common.HexToAddress("0xA4e8C3Ec456107eA67d3075bF9e3DF3A75823DB0"): &Token{
		...
		common.HexToAddress("0x0e0989b1f9B8A38983c2BA8053269Ca62Ec9B195"): &Token{
		...
		common.HexToAddress("0x5732046A883704404F284Ce41FfADd5b007FD668"): &Token{
		...
		common.HexToAddress("0xFA1a856Cfa3409CFa145Fa4e20Eb270dF3EB21ab"): &Token{
		...
		common.HexToAddress("0x1776e1F26f98b1A5dF9cD347953a26dd3Cb46671"): &Token{
		...
		common.HexToAddress("0x408e41876cCCDC0F92210600ef50372656052a38"): &Token{
		...
		common.HexToAddress("0x607F4C5BB672230e8672085532f7e901544a7375"): &Token{
		...
		common.HexToAddress("0x8400D94A5cb0fa0D041a3788e395285d61c9ee5e"): &Token{
		...
		common.HexToAddress("0x4f3AfEC4E5a3F2A6a1A411DEF7D7dFe50eE057bF"): &Token{
		...
		common.HexToAddress("0xEA38eAa3C86c8F9B751533Ba2E562deb9acDED40"): &Token{
		...
		common.HexToAddress("0x543Ff227F64Aa17eA132Bf9886cAb5DB55DCAddf"): &Token{
		...
		common.HexToAddress("0x0E8d6b471e332F140e7d9dbB99E5E3822F728DA6"): &Token{
		...
		common.HexToAddress("0xB62132e35a6c13ee1EE0f84dC5d40bad8d815206"): &Token{
		...
		common.HexToAddress("0xaF4DcE16Da2877f8c9e00544c93B62Ac40631F16"): &Token{
		...
		common.HexToAddress("0x9992eC3cF6A55b00978cdDF2b27BC6882d88D1eC"): &Token{
		...
		common.HexToAddress("0x20F7A3DdF244dc9299975b4Da1C39F8D5D75f05A"): &Token{
		...
		common.HexToAddress("0x1a7a8BD9106F2B8D977E08582DC7d24c723ab0DB"): &Token{
		...
		common.HexToAddress("0x6f259637dcD74C767781E37Bc6133cd6A68aa161"): &Token{
		...
		common.HexToAddress("0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"): &Token{
		...
		common.HexToAddress("0x8f3470A7388c05eE4e7AF3d01D8C722b0FF52374"): &Token{
		...
		common.HexToAddress("0xB24754bE79281553dc1adC160ddF5Cd9b74361a4"): &Token{
		...
		common.HexToAddress("0xC011a73ee8576Fb46F5E1c5751cA3B9Fe0af2a6F"): &Token{
		...
		common.HexToAddress("0x07e3c70653548B04f0A75970C1F81B4CBbFB606f"): &Token{
		...
		common.HexToAddress("0x8207c1FfC5B6804F6024322CcF34F29c3541Ae26"): &Token{
		...
		common.HexToAddress("0x554C20B7c486beeE439277b4540A434566dC4C02"): &Token{
		...
		common.HexToAddress("0x286BDA1413a2Df81731D4930ce2F862a35A609fE"): &Token{
		...
		common.HexToAddress("0xE5a3229CCb22b6484594973A03a3851dCd948756"): &Token{
		...
		common.HexToAddress("0x24692791Bc444c5Cd0b81e3CBCaba4b04Acd1F3B"): &Token{
		...
		common.HexToAddress("0xD46bA6D942050d489DBd938a2C909A5d5039A161"): &Token{
		...
		common.HexToAddress("0x81c9151de0C8bafCd325a57E3dB5a5dF1CEBf79c"): &Token{
		...
		common.HexToAddress("0xa6a840E50bCaa50dA017b91A0D86B8b2d41156EE"): &Token{
		...
		common.HexToAddress("0x4a57E687b9126435a9B19E4A802113e266AdeBde"): &Token{
		...
		common.HexToAddress("0xC86D054809623432210c107af2e3F619DcFbf652"): &Token{
		...
		common.HexToAddress("0x69b148395ce0015c13e36bffbad63f49ef874e03"): &Token{
		...
		common.HexToAddress("0xba11d00c5f74255f56a5e366f4f77f5a186d7f55"): &Token{
		...
		common.HexToAddress("0xa7fc5d2453e3f68af0cc1b78bcfee94a1b293650"): &Token{
		...
		common.HexToAddress("0x7DD9c5Cba05E151C895FDe1CF355C9A1D5DA6429"): &Token{
		...
		common.HexToAddress("0xaa6e8127831c9de45ae56bb1b0d4d4da6e5665bd"): &Token{
		...
		common.HexToAddress("0xba5BDe662c17e2aDFF1075610382B9B691296350"): &Token{
		...
		common.HexToAddress("0xC18360217D8F7Ab5e7c516566761Ea12Ce7F9D72"): &Token{
		...
		common.HexToAddress("0xDd1Ad9A21Ce722C151A836373baBe42c868cE9a4"): &Token{
	...
	42161: {
		...
		common.HexToAddress("0xfa7f8980b0f1e64a2062791cc3b0871572f1f7f0"): &Token{
		...
		common.HexToAddress("0xf97f4df75117a78c1a5a0dbb814af92458539fb4"): &Token{
		...
		common.HexToAddress("0x17fc002b466eec40dae837fc4be5c67993ddbd6f"): &Token{
