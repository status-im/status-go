...
// Source: balance_persistence.go
//
// Generated by this command:
//
//	mockgen -package=mock_balance_persistence -source=balance_persistence.go -destination=mock/balance_persistence/balance_persistence.go
//
...
func (m *MockTokenBalancesStorage) GetTokens() (map[common.Address][]tokentypes.StorageToken, error) {
	m.ctrl.T.Helper()
...
func (m *MockTokenBalancesStorage) SaveTokens(tokens map[common.Address][]tokentypes.StorageToken) error {
	m.ctrl.T.Helper()
