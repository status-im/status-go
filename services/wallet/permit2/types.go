...
var (
	...
	ErrChainNotEnabled       = errors.New("permit path not enabled for chain")
	ErrUntrustedPermitTarget = errors.New("permit contracts do not match the pinned deployment")
)
