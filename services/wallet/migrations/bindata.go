...
var _bindata = map[string]func() ([]byte, error){
	...
	"0002_browsers.up.sql": _0002_browsers_up_sql,
	"doc.go": doc_go,
}
...
var _bintree = &_bintree_t{nil, map[string]*_bintree_t{
	...
	"0002_browsers.up.sql": &_bintree_t{_0002_browsers_up_sql, map[string]*_bintree_t{
	}},
