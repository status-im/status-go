...
type PersistenceInterface interface {
	SaveTransactions(ctx context.Context, chainID uint64, parameters thirdparty.ActivityFetchParameters, activity thirdparty.ActivityTransactionContainer) error
...
func (p *Persistence) SaveTransactions(ctx context.Context, chainID uint64, parameters thirdparty.ActivityFetchParameters, activity thirdparty.ActivityTransactionContainer) (err error) {
	var tx *sql.Tx
	tx, err = p.db.Begin()
	if err != nil {
		return err
