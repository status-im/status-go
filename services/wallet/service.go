...
import (
	...
	protocolCommon "github.com/status-im/status-go/v10/protocol/common"
	...
	"github.com/status-im/status-go/v10/services/wallet/activity"
	...
	"github.com/status-im/status-go/v10/services/wallet/collectibles"
	"github.com/status-im/status-go/v10/services/wallet/community"
	"github.com/status-im/status-go/v10/services/wallet/currency"
	"github.com/status-im/status-go/v10/services/wallet/history"
	"github.com/status-im/status-go/v10/services/wallet/leaderboard"
	"github.com/status-im/status-go/v10/services/wallet/market"
	"github.com/status-im/status-go/v10/services/wallet/onramp"
	"github.com/status-im/status-go/v10/services/wallet/routeexecution"
	"github.com/status-im/status-go/v10/services/wallet/router"
	...
	"github.com/status-im/status-go/v10/services/wallet/thirdparty/collectibles/alchemy"
	"github.com/status-im/status-go/v10/services/wallet/thirdparty/collectibles/opensea"
	"github.com/status-im/status-go/v10/services/wallet/thirdparty/collectibles/rarible"
	"github.com/status-im/status-go/v10/services/wallet/thirdparty/market/coingecko"
