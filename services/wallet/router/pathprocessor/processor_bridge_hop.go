...
import (
	...
	"github.com/status-im/status-go/v10/contracts/hop"
	hopL1CctpImplementation "github.com/status-im/status-go/v10/contracts/hop/l1Contracts/l1CctpImplementation"
	hopL1Erc20Bridge "github.com/status-im/status-go/v10/contracts/hop/l1Contracts/l1Erc20Bridge"
	hopL1EthBridge "github.com/status-im/status-go/v10/contracts/hop/l1Contracts/l1EthBridge"
	hopL1HopBridge "github.com/status-im/status-go/v10/contracts/hop/l1Contracts/l1HopBridge"
	hopL2AmmWrapper "github.com/status-im/status-go/v10/contracts/hop/l2Contracts/l2AmmWrapper"
	hopL2ArbitrumBridge "github.com/status-im/status-go/v10/contracts/hop/l2Contracts/l2ArbitrumBridge"
	hopL2BaseBridge "github.com/status-im/status-go/v10/contracts/hop/l2Contracts/l2BaseBridge"
	hopL2CctpImplementation "github.com/status-im/status-go/v10/contracts/hop/l2Contracts/l2CctpImplementation"
	hopL2OptimismBridge "github.com/status-im/status-go/v10/contracts/hop/l2Contracts/l2OptimismBridge"
