...
//
//	mockgen -package=mock_pathprocessor -source=processor.go -destination=mock/processor.go
//
...
import (
	...
	generator "github.com/status-im/status-go/accounts-management/generator"
...
func (mr *MockPathProcessorMockRecorder) AvailableFor(params any) *gomock.Call {
...
func (mr *MockPathProcessorMockRecorder) BuildTransaction(sendArgs, lastUsedNonce any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockPathProcessor) BuildTransactionV2(sendArgs *wallettypes.SendTxArgs, lastUsedNonce int64) (*types.Transaction, uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPathProcessorMockRecorder) BuildTransactionV2(sendArgs, lastUsedNonce any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPathProcessorMockRecorder) CalculateAmountOut(params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPathProcessorMockRecorder) CalculateFees(params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockPathProcessor) EstimateGas(params pathprocessor.ProcessorInputParams, input []byte) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimateGas", params, input)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPathProcessorMockRecorder) EstimateGas(params, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimateGas", reflect.TypeOf((*MockPathProcessor)(nil).EstimateGas), params, input)
}
...
func (mr *MockPathProcessorMockRecorder) GetContractAddress(params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPathProcessorMockRecorder) PackTxInputData(params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockPathProcessor) Send(sendArgs *pathprocessor.MultipathProcessorTxArgs, lastUsedNonce int64, verifiedAccount *generator.Account) (types0.Hash, uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPathProcessorMockRecorder) Send(sendArgs, lastUsedNonce, verifiedAccount any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
