...
func (h *HopBridge) PackTxInputData(params BridgeParams) ([]byte, error) {
...
func (h *HopBridge) packTxInputDataInternally(params BridgeParams, contractType string) ([]byte, error) {
