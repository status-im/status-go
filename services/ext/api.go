...
func (api *PublicAPI) ImportDiscordCommunity(request *requests.ImportDiscordCommunity) (*protocol.MessengerResponse, error) {
	return api.service.messenger.ImportDiscordCommunity(request)
}
