...
func (m *MessengerSignalsHandler) DownloadingHistoryArchivesFinished(communityID string, from int, to int) {
	signal.SendDownloadingHistoryArchivesFinished(communityID, from, to)
}
