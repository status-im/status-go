...
test-e2e: ##@tests Run e2e tests
	...
	build/env.sh go test -timeout 2m ./e2e/accounts/...
	build/env.sh go test -timeout 2m ./e2e/api/...
	build/env.sh go test -timeout 2m ./e2e/node/...
	...
	build/env.sh go test -timeout 20m ./cmd/statusd
