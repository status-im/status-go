...
func (x *HRHeader) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
var file_protocol_message_proto_rawDesc = []byte{
	...
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70,
...
var file_protocol_message_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_protocol_message_proto_goTypes = []interface{}{
	...
	(*EncryptedMessageProtocol)(nil), // 7: encryption.EncryptedMessageProtocol
	(*ProtocolMessage)(nil),          // 8: encryption.ProtocolMessage
	nil,                              // 9: encryption.Bundle.SignedPreKeysEntry
	nil,                              // 10: encryption.ProtocolMessage.EncryptedMessageEntry
}
var file_protocol_message_proto_depIdxs = []int32{
	9,  // 0: encryption.Bundle.signed_pre_keys:type_name -> encryption.Bundle.SignedPreKeysEntry
	1,  // 1: encryption.BundleContainer.bundle:type_name -> encryption.Bundle
	5,  // 2: encryption.EncryptedMessageProtocol.X3DH_header:type_name -> encryption.X3DHHeader
	3,  // 3: encryption.EncryptedMessageProtocol.DR_header:type_name -> encryption.DRHeader
	4,  // 4: encryption.EncryptedMessageProtocol.DH_header:type_name -> encryption.DHHeader
	6,  // 5: encryption.EncryptedMessageProtocol.HR_header:type_name -> encryption.HRHeader
	1,  // 6: encryption.ProtocolMessage.bundles:type_name -> encryption.Bundle
	10, // 7: encryption.ProtocolMessage.encrypted_message:type_name -> encryption.ProtocolMessage.EncryptedMessageEntry
	0,  // 8: encryption.Bundle.SignedPreKeysEntry.value:type_name -> encryption.SignedPreKey
	7,  // 9: encryption.ProtocolMessage.EncryptedMessageEntry.value:type_name -> encryption.EncryptedMessageProtocol
