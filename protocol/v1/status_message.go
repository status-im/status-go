...
func (m *StatusMessage) HandleApplication() error {
	...
	case protobuf.ApplicationMetadataMessage_CONTACT_VERIFICATION_UNTRUSTWORTHY:
		return m.unmarshalProtobufData(new(protobuf.ContactVerificationUntrustworthy))
