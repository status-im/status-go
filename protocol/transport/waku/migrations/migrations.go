...
func _1561059284_add_waku_keysDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1561059284_add_waku_keys.down.sql", size: 22, mode: os.FileMode(0644), modTime: time.Unix(1579074781, 0)}
...
func _1561059284_add_waku_keysUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1561059284_add_waku_keys.up.sql", size: 109, mode: os.FileMode(0644), modTime: time.Unix(1579074781, 0)}
...
func docGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "doc.go", size: 373, mode: os.FileMode(0644), modTime: time.Unix(1579074781, 0)}
