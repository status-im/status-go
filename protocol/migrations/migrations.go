...
// 1705306742_profile_showcase_address_and_community.up.sql (2.42kB)
// README.md (554B)
// doc.go (850B)
...
func _1705306742_profile_showcase_address_and_communityUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1705306742_profile_showcase_address_and_community.up.sql", size: 2420, mode: os.FileMode(0644), modTime: time.Unix(1706026988, 0)}
