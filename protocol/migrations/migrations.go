...
func _1689931300_add_community_tokens_deployer_and_priv_levelUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1689931300_add_community_tokens_deployer_and_priv_level.up.sql", size: 156, mode: os.FileMode(0644), modTime: time.Unix(1692496473, 0)}
