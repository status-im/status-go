...
func _1675247084_add_activity_center_statesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1675247084_add_activity_center_states.up.sql", size: 136, mode: os.FileMode(0644), modTime: time.Unix(1676629243, 0)}
...
func _1676998418_fix_activity_center_migrationUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1676998418_fix_activity_center_migration.up.sql", size: 178, mode: os.FileMode(0644), modTime: time.Unix(1676998879, 0)}
