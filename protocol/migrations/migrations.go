...
func _1614271809_create_pin_messagesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1614271809_create_pin_messages.up.sql", size: 288, mode: os.FileMode(420), modTime: time.Unix(1618923733, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
