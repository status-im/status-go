...
func _1622061278_add_message_activity_center_notification_fieldUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1622061278_add_message_activity_center_notification_field.up.sql", size: 80, mode: os.FileMode(0644), modTime: time.Unix(1622232111, 0)}
