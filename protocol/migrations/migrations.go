...
func _1684979808_sync_activity_center_notificationsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1684979808_sync_activity_center_notifications.up.sql", size: 169, mode: os.FileMode(0644), modTime: time.Unix(1686577628, 0)}
...
func _1685964183_add_chainids_to_revealed_addressesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1685964183_add_chainids_to_revealed_addresses.up.sql", size: 88, mode: os.FileMode(0644), modTime: time.Unix(1686577628, 0)}
