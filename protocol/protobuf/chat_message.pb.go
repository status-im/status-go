...
const (
	...
	ChatMessage_DISCORD_IMAGE_MESSAGE ChatMessage_ContentType = 13
)
...
type DiscordMessageAuthor struct {
	...
	AvatarImageType      ImageType `protobuf:"varint,7,opt,name=avatarImageType,proto3,enum=protobuf.ImageType" json:"avatarImageType,omitempty"`
	AvatarImageBase64    string    `protobuf:"bytes,8,opt,name=avatarImageBase64,proto3" json:"avatarImageBase64,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *DiscordMessageAuthor) GetAvatarImageType() ImageType {
	if m != nil {
		return m.AvatarImageType
	}
	return ImageType_UNKNOWN_IMAGE_TYPE
}

func (m *DiscordMessageAuthor) GetAvatarImageBase64() string {
	if m != nil {
		return m.AvatarImageBase64
	}
	return ""
}
...
type DiscordMessageAttachment struct {
	...
	Base64               string   `protobuf:"bytes,8,opt,name=base64,proto3" json:"base64,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *DiscordMessageAttachment) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func (m *DiscordMessageAttachment) GetBase64() string {
	if m != nil {
		return m.Base64
	}
	return ""
...
var fileDescriptor_263952f55fd35689 = []byte{
	...
	,
}
