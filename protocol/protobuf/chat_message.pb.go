...
type ImageMessage struct {
	...
	AlbumImagesCount     int32     `protobuf:"varint,6,opt,name=album_images_count,json=albumImagesCount,proto3" json:"album_images_count,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *ImageMessage) GetAlbumImagesCount() int32 {
	if m != nil {
...
var fileDescriptor_263952f55fd35689 = []byte{
	...
	,
}
