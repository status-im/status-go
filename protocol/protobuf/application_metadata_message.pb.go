...
const (
	...
	ApplicationMetadataMessage_CONTACT_VERIFICATION_UNTRUSTWORTHY      ApplicationMetadataMessage_Type = 62
)
...
var ApplicationMetadataMessage_Type_name = map[int32]string{
	...
	62: "CONTACT_VERIFICATION_UNTRUSTWORTHY",
}
...
var ApplicationMetadataMessage_Type_value = map[string]int32{
	...
	"CONTACT_VERIFICATION_UNTRUSTWORTHY":      62,
}
...
var fileDescriptor_ad09a6406fcf24c7 = []byte{
	...
	,
}
