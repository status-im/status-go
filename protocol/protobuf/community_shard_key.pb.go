...
type CommunityShardKey struct {
	...
	ShardCluster         uint32   `protobuf:"varint,4,opt,name=shard_cluster,json=shardCluster,proto3" json:"shard_cluster,omitempty"`
...
func (m *CommunityShardKey) GetShardCluster() uint32 {
	if m != nil {
...
func (m *CommunityShardKey) GetShardIndex() uint32 {
	if m != nil {
		return m.ShardIndex
	}
	return 0
...
var fileDescriptor_03da8310cde9b7b2 = []byte{
	...
	0x52, 0x8b, 0x24, 0x58, 0x14, 0x18, 0x35, 0x78, 0x83, 0x78, 0xc0, 0x82, 0xce, 0x10, 0x31, 0x90,
	...
	0x20, 0x00, 0x00, 0xff, 0xff, 0x67, 0x7a, 0x0d, 0x84, 0xf2, 0x00, 0x00, 0x00,
}
