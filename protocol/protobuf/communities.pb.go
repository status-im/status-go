...
type CommunityPermissions_AllowedPermissions int32

const (
	CommunityPermissions_UNKNOWN    CommunityPermissions_AllowedPermissions = 0
	CommunityPermissions_ADMIN      CommunityPermissions_AllowedPermissions = 1
	CommunityPermissions_MEMBER     CommunityPermissions_AllowedPermissions = 2
	CommunityPermissions_MODERATE   CommunityPermissions_AllowedPermissions = 3
	CommunityPermissions_READ_WRITE CommunityPermissions_AllowedPermissions = 4
	CommunityPermissions_READ       CommunityPermissions_AllowedPermissions = 5
)

var CommunityPermissions_AllowedPermissions_name = map[int32]string{
	0: "UNKNOWN",
	1: "ADMIN",
	2: "MEMBER",
	3: "MODERATE",
...
var CommunityPermissions_AllowedPermissions_value = map[string]int32{
	"UNKNOWN":    0,
	"ADMIN":      1,
	"MEMBER":     2,
	"MODERATE":   3,
...
func (x CommunityPermissions_AllowedPermissions) String() string {
	return proto.EnumName(CommunityPermissions_AllowedPermissions_name, int32(x))
}

func (CommunityPermissions_AllowedPermissions) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f937943d74c1cd8b, []int{2, 1}
}
...
type CommunityPermissions struct {
	...
	EnsSubdomain         string                                    `protobuf:"bytes,4,opt,name=ens_subdomain,json=ensSubdomain,proto3" json:"ens_subdomain,omitempty"`
	Allows               []CommunityPermissions_AllowedPermissions `protobuf:"varint,5,rep,packed,name=allows,proto3,enum=protobuf.CommunityPermissions_AllowedPermissions" json:"allows,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                  `json:"-"`
	XXX_unrecognized     []byte                                    `json:"-"`
	XXX_sizecache        int32                                     `json:"-"`
}
...
func (m *CommunityPermissions) GetEnsSubdomain() string {
	if m != nil {
		return m.EnsSubdomain
	}
	return ""
}

func (m *CommunityPermissions) GetAllows() []CommunityPermissions_AllowedPermissions {
	if m != nil {
		return m.Allows
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("protobuf.CommunityPermissions_AllowedPermissions", CommunityPermissions_AllowedPermissions_name, CommunityPermissions_AllowedPermissions_value)
...
var fileDescriptor_f937943d74c1cd8b = []byte{
	...
	,
}
