...
func (db *Database) GetSettings() (Settings, error) {
	...
	SELECT
		...
		push_notifications_from_contacts_only, remote_push_notifications_enabled, news_push_notifications_enabled, send_push_notifications,
	...
	WHERE
		...
		&s.NewsPushNotificationsEnabled,
