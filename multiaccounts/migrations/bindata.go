...
func _1648646095_image_clockDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1648646095_image_clock.down.sql", size: 939, mode: os.FileMode(0644), modTime: time.Unix(1650628060, 0)}
...
func _1648646095_image_clockUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1648646095_image_clock.up.sql", size: 69, mode: os.FileMode(0644), modTime: time.Unix(1650628060, 0)}
...
func _1649317600_add_color_hashUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1649317600_add_color_hash.up.sql", size: 201, mode: os.FileMode(0644), modTime: time.Unix(1650628060, 0)}
