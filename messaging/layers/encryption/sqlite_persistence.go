...
// AddPrivateBundle adds the specified encryption.BundleContainer to the database
...
// GetRatchetInfo retrieves the existing encryption.RatchetInfo for a specified bundle ID and interlocutor public key from the database
...
// GetAnyRatchetInfo retrieves any existing encryption.RatchetInfo for a specified interlocutor public key from the database
...
// RatchetInfoConfirmed clears the ephemeral key in the encryption.RatchetInfo
