...
import (
	...
	accountssvc "github.com/status-im/status-go/v10/services/accounts"
	appgeneral "github.com/status-im/status-go/v10/services/app-general"
	appmetricsservice "github.com/status-im/status-go/v10/services/appmetrics"
	"github.com/status-im/status-go/v10/services/browsers"
	"github.com/status-im/status-go/v10/services/chat"
	"github.com/status-im/status-go/v10/services/communitytokens"
	"github.com/status-im/status-go/v10/services/connector"
	"github.com/status-im/status-go/v10/services/ens"
	"github.com/status-im/status-go/v10/services/eth"
	"github.com/status-im/status-go/v10/services/gif"
	...
	"github.com/status-im/status-go/v10/services/rpcstats"
	"github.com/status-im/status-go/v10/services/status"
	"github.com/status-im/status-go/v10/services/stickers"
	"github.com/status-im/status-go/v10/services/subscriptions"
	"github.com/status-im/status-go/v10/services/updates"
	"github.com/status-im/status-go/v10/services/wakuv2ext"
	"github.com/status-im/status-go/v10/services/wallet"
	"github.com/status-im/status-go/v10/services/web3provider"
