...
// ../config/cli/fleet-shards.test.json (1.797kB)
...
func ConfigCliFleetShardsTestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-shards.test.json", size: 1797, mode: os.FileMode(0644), modTime: time.Unix(1700000000, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xd4, 0x2a, 0x6b, 0xbd, 0xe0, 0x1b, 0x9c, 0x10, 0xeb, 0x59, 0x1d, 0x86, 0x36, 0x80, 0x12, 0xc6, 0x9d, 0x33, 0x26, 0xf8, 0xda, 0xb8, 0xd7, 0x8d, 0x1f, 0x28, 0xe9, 0x17, 0x7f, 0xd1, 0x82, 0x95}}
	return a, nil
}
