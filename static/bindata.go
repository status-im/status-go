...
func ConfigReadmeMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/README.md", size: 3153, mode: os.FileMode(0644), modTime: time.Unix(1607354881, 0)}
...
func ConfigCliFleetEthProdJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.prod.json", size: 4925, mode: os.FileMode(0644), modTime: time.Unix(1607354881, 0)}
...
func ConfigCliFleetEthStagingJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.staging.json", size: 2307, mode: os.FileMode(0644), modTime: time.Unix(1607354881, 0)}
...
func ConfigCliFleetWakuv2ProdJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-wakuv2.prod.json", size: 744, mode: os.FileMode(436), modTime: time.Unix(1618492539, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func ConfigCliFleetWakuv2TestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-wakuv2.test.json", size: 745, mode: os.FileMode(436), modTime: time.Unix(1618492546, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
