...
class TestMessageReactions(MessengerSteps):
    ...
    def test_one_to_one_message_reactions(self, backend_new_profile, waku_light_client):
        ...
        receiver_chat_id = self.receiver.wakuext_service.rpc_request(method="chats")["result"][0]["id"]
        ...
        emoji_1_id = self.receiver.wakuext_service.rpc_request(method="sendEmojiReaction", params=[receiver_chat_id, message_1["id"], 2])["result"][
            "emojiReactions"
        ][0]["id"]
        self.sender.find_signal_containing_pattern(
            SignalType.MESSAGES_NEW.value,
        ...
        emoji_2_id = self.sender.wakuext_service.rpc_request(method="sendEmojiReaction", params=[sender_chat_id, message_2["id"], 3])["result"][
            "emojiReactions"
        ][0]["id"]
