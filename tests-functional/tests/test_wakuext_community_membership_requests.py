...
class TestCommunityMembershipRequests:
    ...
    def test_pending_request_to_join_community_and_cancel(self, creator, requester, community_id, fake_address):
        req_resp = requester.wakuext_service.request_to_join_community(community_id, [fake_address])
    ...
    def test_pending_request_to_join_community_and_accept(self, creator, requester, community_id, fake_address):
        req_resp = requester.wakuext_service.request_to_join_community(community_id, [fake_address])
        assert len(req_resp.get("requestsToJoinCommunity")) == 1
        assert req_resp.get("requestsToJoinCommunity")[0].get("state") == RequestToJoinState.RequestToJoinStatePending.value
        req_id = req_resp.get("requestsToJoinCommunity")[0].get("id")
    ...
    def test_pending_request_to_join_community_and_decline(self, creator, requester, community_id, fake_address):
        req_resp = requester.wakuext_service.request_to_join_community(community_id, [fake_address])
        assert len(req_resp.get("requestsToJoinCommunity")) == 1
        assert req_resp.get("requestsToJoinCommunity")[0].get("state") == RequestToJoinState.RequestToJoinStatePending.value
        req_id = req_resp.get("requestsToJoinCommunity")[0].get("id")
    ...
    def test_check_and_delete_pending_request_to_join_community(self, creator, requester, community_id, fake_address):
        req_resp = requester.wakuext_service.request_to_join_community(community_id, [fake_address])
        assert len(req_resp.get("requestsToJoinCommunity")) == 1
        req_id = req_resp.get("requestsToJoinCommunity")[0].get("id")
