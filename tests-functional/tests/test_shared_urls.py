...
class TestSharedURLs(MessengerSteps):
    ...
    def test_create_and_share_community_channel_url(self, backend_new_profile):
        ...
        share_resp = backend.sharedurls_service.share_community_channel_url_with_chat_key(self.community_id, channel_id)
        ...
        share_comm_resp = backend.sharedurls_service.share_community_url_with_chat_key(self.community_id)
