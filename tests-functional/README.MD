...
- Every test has two types of verifications:
    ...
    - New schemas can be generated by manually setting `generate_schema=True` to the RPC call and then push the new schema in your PR. But remove the generate_schema before commiting
