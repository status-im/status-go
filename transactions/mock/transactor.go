...
//
//	mockgen -package=mock_transactor -source=transactor.go -destination=mock/transactor.go
//
...
func (m *MockTransactorIface) BuildTransactionWithSignature(chainID uint64, args wallettypes.SendTxArgs, sig []byte) (*types.Transaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockTransactorIface) NextNonce(ctx context.Context, rpcClient rpc.ClientInterface, chainID uint64, from types0.Address) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NextNonce", ctx, rpcClient, chainID, from)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTransactorIfaceMockRecorder) NextNonce(ctx, rpcClient, chainID, from any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NextNonce", reflect.TypeOf((*MockTransactorIface)(nil).NextNonce), ctx, rpcClient, chainID, from)
}
...
func (m *MockTransactorIface) SendTransaction(sendArgs wallettypes.SendTxArgs, verifiedAccount *generator.Account, lastUsedNonce int64) (types0.Hash, uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockTransactorIface) SendTransactionWithChainID(chainID uint64, sendArgs wallettypes.SendTxArgs, lastUsedNonce int64, verifiedAccount *generator.Account) (types0.Hash, uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockTransactorIface) ValidateAndBuildTransaction(chainID uint64, sendArgs wallettypes.SendTxArgs, lastUsedNonce int64) (*types.Transaction, uint64, error) {
	m.ctrl.T.Helper()
