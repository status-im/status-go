...
func _1696853635_input_dataUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1696853635_input_data.up.sql", size: 24129, mode: os.FileMode(0666), modTime: time.Unix(1697097750, 0)}
...
func _1698117918_add_community_id_to_tokensUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1698117918_add_community_id_to_tokens.up.sql", size: 61, mode: os.FileMode(0666), modTime: time.Unix(1698206416, 0)}
