...
func _1699987075_add_timestamp_and_state_to_community_data_cacheUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1699987075_add_timestamp_and_state_to_community_data_cache.up.sql", size: 865, mode: os.FileMode(0644), modTime: time.Unix(1700614276, 0)}
